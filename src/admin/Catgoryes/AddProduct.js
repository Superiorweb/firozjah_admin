    ...
    render() {
        ...
        return (
            <Dashboard>
                <Helmet>
                    <title>
                        ثبت کالا جدید | فروشگاه اینترنتی فیروزجاه
                    </title>
                </Helmet>
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-md-6">
                            <div className="input-group mt-5 w-100 d-flex align-items-center">
                                <label className={csC.lablecatgory+" m-3"}>
                                    انتخاب دسته‌بندی
                                </label>
                                <select className="form-control selection selectbig rounded">
                                    <option>1</option>
                                    <option>1</option>
                                    <option>1</option>
                                    <option>1</option>
                        ...
                        <div className="col-xl-4 col-12">
                            <div className="input-group mt-5 w-100 d-flex justify-content-center align-items-center">
                                <label className={csC.lablecatgory+" m-3"}>
                                    افزودن محصول
                                </label>
                                <input type="text" className="form-control w-25 rounded" placeholder="مانند مد و پوشاک" aria-label="Username"
                                       aria-describedby="basic-addon1"/>
                                {x <= 1000 ? (<button className="btn btn-success w-100 mt-2 mx-2">ثبت</button>) : (     <div className="input-group-prepend ">
                                    <button className="btn btn-success mx-2">ثبت</button>
                                </div>)}
                            </div>
                        </div>
