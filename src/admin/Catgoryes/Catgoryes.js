...
export default class Catgoryes extends Component {
    render() {
        return (
            <Dashboard>
                <Helmet>
                    <title>
                        دسته‌بندی‌ها | فروشگاه اینترنتی فیروزجاه
                ...
                <div className="row mr-0 ml-0 justify-content-center">
                    <div className="col-11 mt-4 mb-4 pb-4 bg-white pt-3">
                        ...
                        <div className={csS.inpcatgory + " input-group mt-5 w-50 align-items-center"}>
                            <label className="m-3">
                                افزودن دسته‌بندی
                            </label>
                            <input type="text" className={csS.addcatgoryinp + " form-control rounded"}
                                   placeholder="مانند مد و پوشاک" aria-label="Username"
                                   aria-describedby="basic-addon1"/>
                            <div className="input-group-prepend">
                                <button className="btn btn-success font-weight-bolder mx-2">ثبت</button>
                            </div>
                        </div>
