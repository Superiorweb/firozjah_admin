...
export default class Daryafti extends Component {
    state={
        datastart:new Date(),
        dataend:new Date(),
    }
                           ...
                           <img className="w-100" src={excel}/>
                                ...
                                <div className="col-12 mt-5">
                                    <div className="row mr-0 ml-0 align-items-center">
                                        <div className="col-lg-6 col-xl-4 col-md-6 col-12 flex-wrap flex-md-nowrap justify-content-center justify-content-md-evenly  px-0 d-flex align-items-center">
                                        ...
                                        <div className="col-lg-6 col-xl-3 col-md-6 col-12 px-0 flex-wrap flex-md-nowrap d-flex justify-content-center justify-content-md-evenly align-items-center">
                                            <label className="w-50">
                                                تا
                                            </label>
                                        ...
                                        <div className="col-md-6 col-xl-2 col-lg-6 col-12 mt-3 mt-xl-0">
                                            <button className="btn w-100 font-weight-bold btn-success">
                                                فیلتر
                                            </button>
                                        </div>
                                        <div className="col-md-6 col-xl-3 col-lg-6 col-12 mt-3 mt-xl-0">
                                            <button className="btn mr-2 w-100 font-weight-bold btn-outline-success">
                                                خروجی اماده واریز
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="table-responsive">
                                <table className="table table-light table-striped table-hover table-bordered table-responsive overflow-hidden">
                                    ...
                                    <tr>
                                        ...
                                        <td>متن نمونه</td>
                                        <td>متن نمونه</td>
                                        <td className="text-center">546641</td>
                                        <td className="text-center">546641</td>
